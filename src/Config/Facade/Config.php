 ...
 * @method static mixed getFromAnySource(string $selector, mixed $defaultValue = NULL) Try to get configuration value from any configuration source. Sources ordered by its priority.
